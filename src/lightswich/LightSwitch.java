 ...
 * @author Owner
 */
public class LightSwitch extends javax.swing.JFrame {

    /**
     * Creates new form LightSwitch
     */
    public LightSwitch() {
        initComponents();
    }
   ...
   jTextField1.setText("on");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LightSwitch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LightSwitch().setVisible(true); 
            }
        });
    }
